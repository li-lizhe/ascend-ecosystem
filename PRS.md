...
| [VoiceStudio](projects/VoiceStudio/) | TTS engine 设备无关（`torch.accelerator` 替代硬编码 CUDA） | [#1830](https://github.com/debpalash/VoiceStudio/pull/1830) · [#1831](https://github.com/debpalash/VoiceStudio/pull/1831) | 2026-09-07 |
| [kornia](projects/kornia/) | RT-DETR device-agnostic map_location | [#4212](https://github.com/kornia/kornia/pull/4212) | 2026-09-05 |
| [kornia](projects/kornia/) | Z1Projection.unproject 标量 depth 设备/dtype 继承 | [#4340](https://github.com/kornia/kornia/pull/4340) | 2026-09-09 |
| [kornia](projects/kornia/) | PinholeCamera.scale_ int64 height/width dtype 提升 | [#4341](https://github.com/kornia/kornia/pull/4341) | 2026-09-09 |
| [kornia](projects/kornia/) | rad2deg/deg2rad 用 math.pi 保留全精度 | [#4356](https://github.com/kornia/kornia/pull/4356) | 2026-09-09 |
| [kornia](projects/kornia/) | bbox_to_mask3d 保留输入 dtype | [#4376](https://github.com/kornia/kornia/pull/4376) | 2026-09-09 |
...
| [spikingjelly](projects/spikingjelly/) | DSpike surrogate 函数重构兼容（`__init__` 参数顺序错位） | [#748](https://github.com/fangwei123456/spikingjelly/pull/748) | 2026-09-08 |

## 📡 跟踪中（PR 待 review / 待回复）

| 项目 | 变更 | PR | 状态 |
|------|------|----|------|
| [kornia](projects/kornia/) | Boxes 整数坐标按默认 dtype 转浮点（5 处 `.float()` → `.to(torch.get_default_dtype())`） | [#4379](https://github.com/kornia/kornia/pull/4379) | 新提交（等待 review） |
...
| [GPT-SoVITS](projects/gpt-sovits/) | 导出脚本 device 无关加速器检测（NPU/XPU/MPS） | [#2837](https://github.com/RVC-Boss/GPT-SoVITS/pull/2837) | 待 review |
...
| [OpenADMET](projects/openadmet/) | TabPFN 模型类 accelerator→device 映射修复 | [#601](https://github.com/OpenADMET/openadmet-models/pull/601) | 新提交（等待 review） |