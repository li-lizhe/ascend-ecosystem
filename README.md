...
| 分类 | 计数 | 详情 |
|------|------|------|
| ✅ **已合并**（上游合入） | 12 | kornia(5) · snntorch(3) · FunASR · VoiceStudio(2) · ComfyUI LayerStyle · spikingjelly |
| 📡 **跟踪中**（PR 待 review） | 15 | 详见下方 |

详见 **[PRS.md](PRS.md)**（已合入 12 个 · 跟踪中 15 个 · 两个表格）。每项目细节见 `projects/<name>/README.md`。
